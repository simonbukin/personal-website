...
#section("Experience")
  ...
  "San Francisco, CA",
  (
    [Building *AI-powered healthcare automation* tools.],
    [Design and frontend development with *React* and *TypeScript*.],
    [Designing and implementing internal tooling for practices to better automate tricky patient-facing workflows.],
  ),
)
