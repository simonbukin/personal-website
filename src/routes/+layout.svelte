...
<body class="bg-gray-800 font-sans text-gray-200">
	...
	<div
		class="border-amber-500 border-fuchsia-500 border-indigo-500 border-rose-500 border-teal-500"
	></div>
	<main class="mx-auto flex min-h-screen max-w-screen-sm flex-col px-4 py-2">
		<nav class="center-with-flex h-fit w-full">
		...
		<div class="my-8 w-full grow">
			<slot />
		</div>

		<footer class="center-with-flex h-fit w-full pb-2 pt-3 text-xl">
