...
<body class="dark:bg-gray-800 dark:text-gray-200 font-sans">
	<main class="flex flex-col min-h-screen lg:max-w-4xl mx-auto py-2 px-4">
		<nav class="center-with-flex h-fit">
			<div class="header center-with-flex gap-4">
				<a class="cursor-pointer no-underline" href="/"><h1 class="text-3xl">simon bukin</h1></a>
				<svg transition:fly class="fill-none w-14" viewBox="0 0 57 38">
					<path
			...
			<ul transition:fly class="right-nav center-with-flex gap-4">
				<HoverLink href="/about"><h2 class="text-2xl">about</h2></HoverLink>
			</ul>
		</nav>
